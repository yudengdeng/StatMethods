...
#Chap 5: To find P(X < 72)
pnorm(72, mean=70, sd=3)


#Chap 5: To find that 85th percentile of a normal distribution whose mean is 70 and whose standard deviation is 3.
qnorm(0.85,mean=70,sd=3)
#Chap 6: To find the critical value for 98% Confidence level
...
#load the data
dta_tmp <- read.csv(file = "/Users/YuDengdeng/Dropbox/Classes/STAT 3316 2021A/ncbirth1450.csv")
dta_tmp_new <- dta_tmp[rowSums(dta_tmp == "#NULL!")<1,] #delete the data including"#NULL!"
summary(dta_tmp_new)
